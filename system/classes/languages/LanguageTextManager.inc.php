<?php
/* --------------------------------------------------------------
  LanguageTextManager.inc.php 2016-11-11
  Gambio GmbH
  http://www.gambio.de
...
class LanguageTextManager
{
	...
	protected function _initMappingArray()
	{
		...
		$mappingArray = array(
			...
			'modules/order_total/ot_paypal3_instfee.php'       => 'ot_paypal3_instfee_module',
			...
			'modules/payment/paypal3_installments.php'         => 'paypal3installments_module',
