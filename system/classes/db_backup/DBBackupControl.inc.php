<?php
/* --------------------------------------------------------------
   DBBackupControl.inc.php 2017-01-10
   Gambio GmbH
   http://www.gambio.de
...
class DBBackupControl
{
	...
	{
		$t_return = $this->v_backup_temp_file_path . $p_table_name . '.sql';
		
		$t_files_array = glob($this->v_backup_temp_file_path . $p_table_name . '.sql');
