<?php
/* --------------------------------------------------------------
	PayPalConfigurationStorage.inc.php 2016-10-20
	Gambio GmbH
	http://www.gambio.de
...
class PayPalConfigurationStorage extends ConfigurationStorage
{
	...
	protected function setDefaultConfiguration()
	{
		$this->default_configuration = array(
				...
				'debug_logging' => '1',
				'allow_selfpickup' => '0',
				'show_installments_presentment_specific_product'   => '1',
				'show_installments_presentment_specific_cart'      => '1',
				'show_installments_presentment_specific_payment'   => '1',
				'show_installments_presentment_specific_computed'  => '1',
				'pui_invoice_hide_column' => '3',
			);
