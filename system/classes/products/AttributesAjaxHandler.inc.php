		...
		switch($t_action_request)
		{
			case 'calculate_price':
						...
						)
				{
					...
					if(isset($t_details_array['products_vpe_id']) && $t_details_array['products_vpe_id'] > 0 && !$coo_properties_control->has_non_linear_combi_surcharge((int)$this->v_data_array['POST']['products_id']))
					{
