...
class AddressBookProcessContentControl extends DataProcessing
{
	...
	protected function get_address_data_from_user_input()
	{
		...
		$t_house_number = (ACCOUNT_SPLIT_STREET_INFORMATION == 'true') ? xtc_db_prepare_input($this->v_data_array['POST']['house_number']) : '';
		$this->coo_address->set_('entry_house_number', $t_house_number);
	...
	protected function update_customer()
	{
		...
		{
			$this->wrapped_db_perform(__FUNCTION__, TABLE_ADDRESS_BOOK, array('entry_house_number' => ''), 'update', "customers_id = '" . (int)$this->customer_data_array['customers_id'] . "'");
		}
