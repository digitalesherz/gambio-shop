...
$coo_scroller = MainFactory::create_object('ScrollerBoxContentView');
$coo_scroller->set_('language_id', $_SESSION['languages_id']);
$t_box_html = $coo_scroller->get_html();

$gm_box_pos = $GLOBALS['coo_template_control']->get_menubox_position('gm_scroller');
