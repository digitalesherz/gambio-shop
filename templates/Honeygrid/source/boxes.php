...
if($GLOBALS['coo_template_control']->get_menubox_status('paypalinstallments')) include(DIR_WS_BOXES.'paypalinstallments.php');
...
if($GLOBALS['coo_template_control']->get_menubox_status('admin') && $_SESSION['customers_status']['customers_status_id'] === '0' && (int)$_SESSION['customer_id'] > 0) include(DIR_WS_BOXES.'admin.php');
